## Context
Octopus was built at V@COMM to help credit unions run service collections with clear reconciliation and daily operational visibility.

The platform was deployed in two credit unions (El Progreso and San Martin) and supported telecom collection flows, including ENTEL recharges and postpaid payments.

## Problem
Union operators needed a reliable way to process high-volume collections while keeping settlement, commissions, and daily reconciliation accurate.
...
- Commission and settlement logic had to be auditable by credit union teams.
...
I also implemented settlement and commission rules so credit union teams could track daily collections and earnings without manual reconciliation.

## Results
- Approximately 1,000 daily service-collection operations in active production.
- Deployment across two credit unions with recurring real-world usage.
