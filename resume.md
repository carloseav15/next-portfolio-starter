...
*Mobile & E-Commerce Systems Engineer (Full-Time)* | **Dec 2019 – Jun 2024**  
*One of Bolivia’s largest B2B technology distributors (170+ professionals, operations in Bolivia, Peru, and Chile).*
...
*Community operations platform providing membership, geolocation, and event reporting systems.*
...
*   *Tech Stack:* HTML, CSS, JS, PHP, MySQL, Android (Java/XML), iOS (Objective-C), Flutter (Dart).

### **Tismart (DATEC Division)** | Santa Cruz, Bolivia  
*Junior Android Developer (Full-Time)* | **Jan 2015 – May 2016**  
...
*IT Support / Data Center Operations (Full-Time)* | **Aug 2014 – Dec 2014**  
...
*   *Tech Stack:* Next.js 16 (App Router), React 19, TypeScript, Tailwind CSS v4, Supabase (PostgreSQL), Biome, Vitest, Playwright.
